// helper functions for enabling the nav tabs moving decpration
...
var findActiveItemParams = function findActiveItemParams(activeItemIndex) {
  ...
  var parentPos = document.getElementById("parent-id").getBoundingClientRect(),
    style = window.getComputedStyle(
      document.getElementById("container-padding")
    ),
  ...
  var activeItemOffset_left = window.location.href.includes("index_en")
    ? left
    : right; //17 for scrollbar
