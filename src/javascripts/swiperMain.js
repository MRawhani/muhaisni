...
function initNestedSliders() {
  ...
  var swiperNestedClients1 = new SwiperCore(
    ".swiper-container-clients-nested1",
    clientesSettings
  );
  var swiperNestedClients2 = new SwiperCore(
    ".swiper-container-clients-nested2",
    clientesSettings
  );
  var swiperNestedClients3 = new SwiperCore(
    ".swiper-container-clients-nested3",
    { ...clientesSettings, speed: 46000 }
  );
  var swiperNestedClients4 = new SwiperCore(
    ".swiper-container-clients-nested4",
    { ...clientesSettings, speed: 30000 }
  );
  function infinite1() {
    swiperNestedClients1.slideTo(swiperNestedClients1.slides.length);
    swiperNestedClients1.once("transitionEnd", function () {
      swiperNestedClients1.slideTo(
        swiperNestedClients1.params.slidesPerView,
        0,
        false
      );
      setTimeout(function () {
  ...
  function infinite2() {
    ...
    swiperNestedClients2.once("transitionEnd", function () {
      swiperNestedClients2.slideTo(
        swiperNestedClients2.params.slidesPerView,
        0,
        false
      );
      setTimeout(function () {
  ...
  function infinite3() {
    ...
    swiperNestedClients3.once("transitionEnd", function () {
      swiperNestedClients3.slideTo(
        swiperNestedClients3.params.slidesPerView,
        0,
        false
      );
      setTimeout(function () {
  ...
  function infinite4() {
    ...
    swiperNestedClients4.once("transitionEnd", function () {
      swiperNestedClients4.slideTo(
        swiperNestedClients4.params.slidesPerView,
        0,
        false
      );
      setTimeout(function () {
  ...
  // these functions for making an infinit movement in the clients logos slider
  infinite1();
  infinite2();
  infinite3();
  infinite4();
  ...
  var swiperNestedCompanies = new SwiperCore(
    ".swiper-container-companies-nested",
    {
      ...
      breakpoints: {
        ...
        1600: {
          slidesPerView:
            dimentions.height < 900 && dimentions.height > 800 ? 2.7 : 3.2,
        },
        1900: {
          spaceBetween: 40,
